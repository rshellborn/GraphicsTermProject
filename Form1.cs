...
namespace asgn5v1
{
	...
	public class Transformer : System.Windows.Forms.Form
	{
		...
		public Transformer()
		{
			...
			Text = "COMP 4560:  Assignment 5 (200830) (Rachel Shellborn)";
			ResizeRedraw = true;
        ...
        /*
         * Initial setup of the shape in the middle of the window with correct scale factor. 
         */
        void Init()
        {
            ...
            // Translate to origin and reflect in xz plane
            tnet = MultiplyMatrix(translate(-axisX, -axisY, 0), reflectIn("xz"));
            // Scale shape
            tnet = MultiplyMatrix(tnet, scale(sfactor));
            // Translate to centre of the window
            this.ctrans = MultiplyMatrix(tnet, translate(x, y, 0));
        }
        ...
        /*
         * Helper method for uniform scaling.
         */
        ...
        /*
         * Helper method for reflection in a specific plane.
         */
        double[,] reflectIn(string plane)
        {
            double[,] A = new double[4, 4];
        ...
        /*
        * Helper method for rotation in a specific axis.
        */
        double[,] rotateIn(char axis)
        {
		...
		private void toolBar1_ButtonClick(object sender, System.Windows.Forms.ToolBarButtonClickEventArgs e)
		{
			...
			if (e.Button == scaleupbtn) 
			{
                ...
                //apply uniform scale
                ctrans = MultiplyMatrix(ctrans, scale(1.1d));
                //translate back
                ctrans = MultiplyMatrix(ctrans, translate(scrnpts[0, 0], scrnpts[0, 1], scrnpts[0, 2]));
                Refresh();
			}
			if (e.Button == scaledownbtn) 
			{
                ...
                ctrans = MultiplyMatrix(ctrans, translate(-scrnpts[0, 0], -scrnpts[0, 1], -scrnpts[0, 2]));
                //apply uniform scale
                ctrans = MultiplyMatrix(ctrans, scale(0.9d));
                //translate back
                ctrans = MultiplyMatrix(ctrans, translate(scrnpts[0, 0], scrnpts[0, 1], scrnpts[0, 2]));
                Refresh();
			}
